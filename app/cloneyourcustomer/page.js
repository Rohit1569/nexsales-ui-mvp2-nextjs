...
//       </div>
//       <div className="flex">
//         <div className=" w-1/2 h-[900px] items-center">
//           <div className="w-1/2 h-[450px] ml-[118px] mt-[150px]">
//             <div className="item-center flex flex-col gap-3 self-stretch">
//               <div className="">
//                 <text className="font-inter text-[30px] not-italic font-semibold leading-9">
//                   Log In to your account
//                 </text>
//               </div>
//               <div className="item-center text-center">
//                 <text className="text-[#667085] text-base not-italic font-normal">
//                   Access your account and get started with market sizing
//                 </text>
//               </div>
//             </div>
//           </div>
    ...
    <>
      ...
      <div className=" w-full  m-0 p-0 ">
        <div
          ...
          className=" shadow-xl ml-[60px] mt-[-580px] z-1 flex justify-center item-center p-[10px] py-[50px]"
        >
